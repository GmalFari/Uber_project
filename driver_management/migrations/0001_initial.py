        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "marital_status",
                    models.CharField(
                        choices=[("M", "Married"), ("S", "Single")], max_length=10
                    ),
                ),
                (
                    "religion",
                ...
                (
                    "driver_type",
                    models.CharField(
                        choices=[("TEM", "Temporary"), ("PER", "Permanent")],
                        default="TEM",
                        max_length=10,
                    ),
                ),
                ...
                (
                    "passport",
                    models.CharField(
                        choices=[("1", "Yes"), ("2", "No")], max_length=10
                    ),
                ),
                ...
                (
                    "driving_status",
                    models.CharField(
                        choices=[("1", "Approve"), ("2", "Reject")], max_length=10
                    ),
                ),
                (
                    "is_approval_done",
                ...
                (
                    "scheme_type",
                    models.CharField(
                        choices=[("1", "Platinum"), ("2", "Gold"), ("3", "Silver")],
                        max_length=10,
                    ),
                ),
                (
